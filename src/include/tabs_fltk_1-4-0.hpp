...
// Other that the change to the name of the class, and include location, it is the same file with the same original attribution.
// All changes Copright (c) Richard Spinney 2021. These changes are released in accordance with the FLTK license.
...
#ifndef Fl_Tabs_140_H
#define Fl_Tabs_140_H
...
*/
class FL_EXPORT fl_tabs_1_4_0 : public Fl_Group {
...
public:
  ...
  fl_tabs_1_4_0(int X, int Y, int W, int H, const char *L = 0);
  virtual ~fl_tabs_1_4_0();
